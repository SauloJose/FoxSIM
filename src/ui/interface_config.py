...
COEFFICIENT_RESTITUTION_ROBOT_FIELD = 0.5

#COEFICIENTES DE ATRITO
COEFICIENT_FRICTION_ROBOT_FIELD = 0.1
COEFICIENT_FRICTION_ROBOT_ROBOT = 0.9
COEFICIENT_FRICTION_BALL_FIELD = 0.4
COEFICIENT_FRICTION_BALL_ROBOT = 0.5
