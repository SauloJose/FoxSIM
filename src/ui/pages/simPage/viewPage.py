...
class SimulationViewPage(BasicPage):
    ...
    def create_top_section(self):
        ...
        self.buttonStart.clicked.connect(self.test_draw)
    ...
    def test_draw(self):
        """Testa o desenho no SimWidget"""
        if hasattr(self, 'viewer'):
            # Limpa o back buffer
            self.viewer.back_buffer.clear()
            
            # Desenha um retângulo vermelho
            self.viewer.back_buffer.draw_rect(
                x=100, y=100, 
                w=50, h=50, 
            ...
            self.viewer.back_buffer.draw_circle(
                x=200, y=200, 
                radius=30, 
            ...
            self.viewer.back_buffer.draw_line(
                x1=300, y1=300,
                x2=400, y2=400,
