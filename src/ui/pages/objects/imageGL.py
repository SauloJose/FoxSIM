...
class Image:
    ...
    def __init__(self, filepath=None, default_scale=1.0):
        ...
        self._flip_x = False
        self._flip_y = False
        self._image_data = None  # Inicializa o atributo
        self._numpy_array = None  # Inicializa o atributo
    ...
    def load_image(self):
        # Carrega a imagem e converte para um formato utilizável pelo VisPy
        from vispy.io import read_png
        self._image_data = read_png(self.image_path)

    def get_numpy(self):
        """Retorna os dados da imagem como um array NumPy."""
        return self._numpy_array

    def is_valid(self):
        """Verifica se a imagem foi carregada corretamente."""
        return self._numpy_array is not None