...
class CTPIDControlPage(BasicPage):
    ...
    def run_simulation(self):
        ...
        for _ in range(max_steps):
            ...
            v_l, v_r, is_finished = bot.goto_point(np.array([x1, y1]), a1, dt)
            ...
            if is_finished or self.break_flag==True:
                #Quando a go_to_point retorna o is_finish como True, o robô chegou ao ponto desejado e alinhado
