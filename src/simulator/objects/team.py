...
class Team:
    ...
    """
    def __init__(self, positions: Position, team_name, initial_angle=0, space=None):
        self.team_name = team_name
        self.initial_angle = initial_angle
        self.positions = positions
        self.space = space  # Armazena o espaço Pymunk para repassar aos robôs
        ...
        self.ATA1_image = pygame.transform.smoothscale(
            pygame.image.load("src/assets/ATA1.png").convert_alpha(), scale)
        self.ATA2_image = pygame.transform.smoothscale(
            pygame.image.load("src/assets/ATA2.png").convert_alpha(), scale)
        self.ATGK_image = pygame.transform.smoothscale(
            pygame.image.load("src/assets/ATGK.png").convert_alpha(), scale)
        self.ally_images = [self.ATGK_image, self.ATA1_image, self.ATA2_image]

        # Imagens dos inimigos com máxima qualidade
        self.ETA1_image = pygame.transform.smoothscale(
            pygame.image.load("src/assets/ETA1.png").convert_alpha(), scale)
        self.ETA2_image = pygame.transform.smoothscale(
            pygame.image.load("src/assets/ETA2.png").convert_alpha(), scale)
        self.ETGK_image = pygame.transform.smoothscale(
            pygame.image.load("src/assets/ETGK.png").convert_alpha(), scale)
        ...
        self.goalkeeper = Robot(
            ...
            space=self.space  # Repassa o espaço
        )
        ...
        self.robots = [self.goalkeeper, self.atacker1, self.atacker2]
    ...
    def set_positions(self, positions: Position):
        ...
        """
        self.goalkeeper.set_position(positions.GoalKeeperP[0], positions.GoalKeeperP[1])
